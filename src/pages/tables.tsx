...
const initialProducts: Product[] = [
  {
    ...
    imageGallery: [
      {
        img: "./images/Products-img/tablesImg/tables1.jpg",
      },
      {
        img: "./images/Products-img/tablesImg/tables1.1.jpg",
      },
    ],
      ...
      <div className="flex justify-center px-6 pt-12 pb-12 mx-auto text-center max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-black">
            Подчертайте забавленията и общуването с близките с нашите дървени
            маси. Създайте централно място за споделяне на вкусни ястия и
            незабравими моменти.
          </p>
        </div>
      </div>
