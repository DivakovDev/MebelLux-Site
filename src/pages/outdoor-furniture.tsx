    ...
    imageGallery: [
        {
          ...
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture2.1.jpg",
          },
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture2.2.jpg",
          },
    ],
    ...
    imageGallery: [
        {
          ...
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture3.1.jpg",
          },
    ],
    ...
    imageGallery: [
        {
          ...
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture5.1.jpg",
          },
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture5.2.jpg",
          },
          {
            img: "./images/Products-img/outdoor-furnitureImg/outdoor-furniture5.3.jpg",
          },
    ],
      ...
      <div className="flex justify-center px-6 pt-12 pb-12 mx-auto text-center max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-black">
            Пренесете уюта на дома си на открито с нашите дървени градински
            мебели. Релаксирайте сред природата, съчетавайки комфорт и естетика
            в градинския си оазис.
          </p>
        </div>
      </div>
      <div className="max-w-2xl px-4 py-16 mx-auto border-t sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">
          Най-продавани Градински-мебели
        </h2>
