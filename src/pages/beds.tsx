...
export default function Example() {
  ...
  const nextSlide = () => {
    if (!selectedProduct) return;
    const isLastSlide =
      selectedProduct.curIndex === selectedProduct.imageGallery.length - 1;
          ...
          {products.map((product) => (
            <div key={product.id} className="relative group">
              ...
              <button
                ...
                className="flex w-full mx-auto overflow-hidden"
              >
                <img
            ...
            >
              <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex items-center justify-center min-h-full p-4">
                  ...
                  >
                    <Dialog.Panel className="w-full max-w-lg p-6 pb-10 rounded-xl bg-white/5 backdrop-blur-2xl">
                      <button
