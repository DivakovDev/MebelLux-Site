          ...
          <div className="relative max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div className="pt-12 sm:pt-16 lg:pt-20">
              ...
              <div className="mt-6 space-y-6 text-gray-500">
                <p className="text-lg">
                  Фирма Мебеллукс - М произвежда мебели от естествена дървесина.
                  ...
                  ни се е наложила на пазара благодарение на качество,
                  конкурентни цени и най - вече на стремежа за удовлетворяване
